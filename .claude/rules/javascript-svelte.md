...
- **NEVER use ES6 classes** - Use factory functions that return objects with
  methods
- **Use closures for state management** - Encapsulate state in function scope
- **Use pure functions** - Functions should not mutate arguments or have side
  effects
- **Prefer composition over inheritance** - Build complex behavior by combining
  simple functions
